...
keywords_qc224.SQL <- RMySQL::dbSendQuery(
  con, paste(
    ...
    "WHERE (
          ...
          (LOWER(keywords.keyword) LIKE '%classical%' AND LOWER(keywords.keyword) LIKE '%capacit%') OR 
          (LOWER(keywords.keyword) LIKE '%quantum%' AND LOWER(keywords.keyword) LIKE '%capacit%') OR 
          (LOWER(keywords.keyword) LIKE '%private%' AND LOWER(keywords.keyword) LIKE '%capacit%') OR 
          LOWER(keywords.keyword) LIKE '%cryptogrph%' OR 
          LOWER(keywords.keyword) LIKE '%primitive%' OR 
          (LOWER(keywords.keyword) LIKE '%quantum%' AND LOWER(keywords.keyword) LIKE '%concentration%')
      ) AND NOT (
      ...
      (LOWER(keywords.keyword) LIKE '%quantum%' OR LOWER(keywords.keyword) LIKE '%qubit%') AND (
          ...
          (LOWER(keywords.keyword) LIKE '%Communication channels%' AND (LOWER(keywords.keyword) LIKE '%Decision theory%' OR LOWER(keywords.keyword) LIKE '%Decision problems%' OR LOWER(keywords.keyword) LIKE '%Distinguishability%') AND (LOWER(keywords.keyword) LIKE '%Dynamical maps%' OR LOWER(keywords.keyword) LIKE '%Quantum entanglement%')) OR
...
length(unique(keywords_qc224$pubid)) # 2538
...
publication_qc224.SQL <- RMySQL::dbSendQuery(
  con, paste(
    ...
    "WHERE ((
          ...
          (LOWER(publication.abstract) LIKE '%classical%' AND LOWER(publication.abstract) LIKE '%capacit%') OR 
          (LOWER(publication.abstract) LIKE '%quantum%' AND LOWER(publication.abstract) LIKE '%capacit%') OR 
          (LOWER(publication.abstract) LIKE '%private%' AND LOWER(publication.abstract) LIKE '%capacit%') OR 
          LOWER(publication.abstract) LIKE '%cryptogrph%' OR 
          LOWER(publication.abstract) LIKE '%primitive%' OR 
          (LOWER(publication.abstract) LIKE '%quantum%' AND LOWER(publication.abstract) LIKE '%concentration%')
      ) AND NOT (
      ...
      (LOWER(publication.abstract) LIKE '%quantum%' OR LOWER(publication.abstract) LIKE '%qubit%') AND (
          ...
          (LOWER(publication.abstract) LIKE '%Communication channels%' AND (LOWER(publication.abstract) LIKE '%Decision theory%' OR LOWER(publication.abstract) LIKE '%Decision problems%' OR LOWER(publication.abstract) LIKE '%Distinguishability%') AND (LOWER(publication.abstract) LIKE '%Dynamical maps%' OR LOWER(publication.abstract) LIKE '%Quantum entanglement%')) OR
    ...
    ((
          ...
          (LOWER(publication.itemtitle) LIKE '%classical%' AND LOWER(publication.itemtitle) LIKE '%capacit%') OR 
          (LOWER(publication.itemtitle) LIKE '%quantum%' AND LOWER(publication.itemtitle) LIKE '%capacit%') OR 
          (LOWER(publication.itemtitle) LIKE '%private%' AND LOWER(publication.itemtitle) LIKE '%capacit%') OR 
          LOWER(publication.itemtitle) LIKE '%cryptogrph%' OR 
          LOWER(publication.itemtitle) LIKE '%primitive%' OR 
          (LOWER(publication.itemtitle) LIKE '%quantum%' AND LOWER(publication.itemtitle) LIKE '%concentration%')
      ) AND NOT (
      ...
      (LOWER(publication.itemtitle) LIKE '%quantum%' OR LOWER(publication.itemtitle) LIKE '%qubit%') AND (
          ...
          (LOWER(publication.itemtitle) LIKE '%Communication channels%' AND (LOWER(publication.itemtitle) LIKE '%Decision theory%' OR LOWER(publication.itemtitle) LIKE '%Decision problems%' OR LOWER(publication.itemtitle) LIKE '%Distinguishability%') AND (LOWER(publication.itemtitle) LIKE '%Dynamical maps%' OR LOWER(publication.itemtitle) LIKE '%Quantum entanglement%')) OR
...
length(unique(publication_qc224$pubid)) # 71,905
  ...
  con, paste(
    ...
    "WHERE ((
      ...
      AND (
          ...
          LOWER(keywords.keyword) LIKE '%parts%' OR
          LOWER(keywords.keyword) LIKE '%component%' OR
          LOWER(keywords.keyword) LIKE '%componet%' OR
          LOWER(keywords.keyword) LIKE '%compone%' OR
          LOWER(keywords.keyword) LIKE '%equipment%' OR
          LOWER(keywords.keyword) LIKE '%machine%' OR
          LOWER(keywords.keyword) LIKE '%facilities%' OR
          LOWER(keywords.keyword) LIKE '%apparatus%' OR
          LOWER(keywords.keyword) LIKE '%opperator%' OR
          LOWER(keywords.keyword) LIKE '%tools%' OR
          LOWER(keywords.keyword) LIKE '%eqipment%' OR
          LOWER(keywords.keyword) LIKE '%device%' OR
          LOWER(keywords.keyword) LIKE '%apparat%' 
      )) AND
      ((
      ...
      AND (
          ...
          LOWER(keywords.keyword) LIKE '%crystaline%' OR
...
length(unique(keywords_qc421$pubid)) # 818
  ...
  con, paste(
    ...
    "WHERE (((
      ...
      AND (
          ...
          LOWER(publication.abstract) LIKE '%parts%' OR
          LOWER(publication.abstract) LIKE '%component%' OR
          LOWER(publication.abstract) LIKE '%componet%' OR
          LOWER(publication.abstract) LIKE '%compone%' OR
          LOWER(publication.abstract) LIKE '%equipment%' OR
          ...
          LOWER(publication.abstract) LIKE '%opperator%' OR
          LOWER(publication.abstract) LIKE '%tools%' OR
          LOWER(publication.abstract) LIKE '%eqipment%' OR
          LOWER(publication.abstract) LIKE '%device%' OR
          LOWER(publication.abstract) LIKE '%apparat%' 
      )) AND
      ((
      ...
      AND (
          ...
          LOWER(publication.abstract) LIKE '%crystaline%' OR
    ...
    (((
      ...
      AND (
          ...
          LOWER(publication.itemtitle) LIKE '%parts%' OR
          LOWER(publication.itemtitle) LIKE '%component%' OR
          LOWER(publication.itemtitle) LIKE '%componet%' OR
          LOWER(publication.itemtitle) LIKE '%compone%' OR
          LOWER(publication.itemtitle) LIKE '%equipment%' OR
          ...
          LOWER(publication.itemtitle) LIKE '%opperator%' OR
          LOWER(publication.itemtitle) LIKE '%tools%' OR
          LOWER(publication.itemtitle) LIKE '%eqipment%' OR
          LOWER(publication.itemtitle) LIKE '%device%' OR
          LOWER(publication.itemtitle) LIKE '%apparat%' 
      )) AND
      ((
      ...
      AND (
          ...
          LOWER(publication.itemtitle) LIKE '%crystaline%' OR
...
length(unique(publication_qc421$pubid)) # 34159
...
length(unique(keywords_qc422$pubid)) # 50
...
length(unique(publication_qc422$pubid)) # 22,286
  ...
  con, paste(
    ...
    "WHERE (
      ...
      (
          ...
          LOWER(keywords.keyword) LIKE '%dielectronic%' OR
  ...
  con, paste(
    ...
    "WHERE ((
      ...
      (
          ...
          LOWER(publication.abstract) LIKE '%dielectronic%' OR
  ...
  con, paste(
    ...
    "WHERE (
      ...
      AND (
          ...
          LOWER(keywords.keyword) LIKE '%radom%' OR
          LOWER(keywords.keyword) LIKE '%wave%' OR
          LOWER(keywords.keyword) LIKE '%waved%' OR
          LOWER(keywords.keyword) LIKE '%pleat%' OR
          LOWER(keywords.keyword) LIKE '%undulating%' OR
          LOWER(keywords.keyword) LIKE '%undulatory%' OR
          LOWER(keywords.keyword) LIKE '%wavelike%' OR
          LOWER(keywords.keyword) LIKE '%wavy%' OR
  ...
  con, paste(
    ...
    "WHERE ((
      ...
      AND (
          ...
          LOWER(publication.abstract) LIKE '%radom%' OR
          LOWER(publication.abstract) LIKE '%wave%' OR
          LOWER(publication.abstract) LIKE '%waved%' OR
          LOWER(publication.abstract) LIKE '%pleat%' OR
          LOWER(publication.abstract) LIKE '%undulating%' OR
          LOWER(publication.abstract) LIKE '%undulatory%' OR
          LOWER(publication.abstract) LIKE '%wavelike%' OR
          LOWER(publication.abstract) LIKE '%wavy%' OR
      ...
      AND (
          ...
          LOWER(publication.itemtitle) LIKE '%radom%' OR
          LOWER(publication.itemtitle) LIKE '%wave%' OR
          LOWER(publication.itemtitle) LIKE '%waved%' OR
          LOWER(publication.itemtitle) LIKE '%pleat%' OR
          LOWER(publication.itemtitle) LIKE '%undulating%' OR
          LOWER(publication.itemtitle) LIKE '%undulatory%' OR
          LOWER(publication.itemtitle) LIKE '%wavelike%' OR
          LOWER(publication.itemtitle) LIKE '%wavy%' OR
...
length(unique(publication_qc424$pubid)) # 23
